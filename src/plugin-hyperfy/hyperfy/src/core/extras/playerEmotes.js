export const Emotes = {
  ...
  SPRINT: 'asset://emote-sprint.glb?s=1.5',
  JUMP: 'asset://emote-jump.glb',
  JUMP_LEFT: 'asset://emote-jump-left.glb',
  JUMP_RIGHT: 'asset://emote-jump-right.glb',
  FALL: 'asset://emote-fall.glb',
  FLY: 'asset://emote-float.glb',
  FLIP: 'asset://emote-flip.glb?s=1.1',
  FLIP_LEFT: 'asset://emote-flip-left.glb?s=1.1',
  FLIP_RIGHT: 'asset://emote-flip-right.glb?s=1.1',
  BACKFLIP: 'asset://emote-backflip.glb?s=1.1',
