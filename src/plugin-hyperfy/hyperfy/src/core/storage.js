...
class NodeStorage {
  constructor() {
    ...
    console.log('[NodeStorage] Looking for localstorage.json at:', this.file)
    try {
      const data = fs.readFileSync(this.file, 'utf8')
      this.data = JSON.parse(data)
      console.log('[NodeStorage] Loaded data:', Object.keys(this.data))
    } catch (err) {
      console.log('[NodeStorage] Failed to load storage file:', err.message)
      this.data = {}
    }
  }
