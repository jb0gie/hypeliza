  ...
  applyAvatar() {
    ...
    this.world.loader
      ...
      .then(src => {
        ...
        this.nametag.position.y = (this.avatar?.getHeadToHeight && this.avatar?.getHeadToHeight() || 0) + 0.2
        this.bubble.position.y = (this.avatar?.getHeadToHeight && this.avatar?.getHeadToHeight() || 0) + 0.2
