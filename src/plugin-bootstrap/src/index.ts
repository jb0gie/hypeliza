...
const messageReceivedHandler = async ({
  ...
  // Add a log to check if messages from Hyperfy are reaching this handler
  if (message.content.source === 'hyperfy') {
    logger.info(`[Bootstrap] Received Hyperfy message ${message.id} in handler.`);
  }
